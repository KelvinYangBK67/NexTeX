...
- Made term sort keys and descriptions optional, localized default parentheses, and changed the index title default to the localized standard `\indexname`.
...
- 術語排序 key 與說明改為可選，預設括號會依 UI 本地化，索引標題則改用本地化的標準 `\indexname`。
